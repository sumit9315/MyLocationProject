...
namespace Hestia.LocationsMDM.WebApi.Exceptions
{
    /// <summary>
    /// This exception indicates that there is a conflict when creating/updating data in persistence,
    /// for example the entity was expired or duplicate endtity is being created.
    /// </summary>
    [Serializable]
    public class DataConflictException : PersistenceException
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataConflictException"/> class with serialized data.
        /// </summary>
        ///
        /// <param name="info">
