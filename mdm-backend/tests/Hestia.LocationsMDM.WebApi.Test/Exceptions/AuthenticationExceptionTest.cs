...
namespace Hestia.LocationsMDM.WebApi.Test
{
    ...
    public class AuthenticationExceptionTest
    {
        ...
        /// <summary>
        /// <para>Tests <see cref="AuthenticationException()"/> constructor and inheritance.</para>
        ///
        ...
        /// <summary>
        /// <para>Tests <see cref="AuthenticationException(string, Exception)"/> constructor
        ...
        /// <summary>
        /// <para>Test <see cref="AuthenticationException(string, Exception)"/> constructor
        ...
        /// <summary>
        /// <para>Tests <see cref="AuthenticationException(SerializationInfo, StreamingContext)"/> constructor.</para>
        ///
        ...
        public void TestCtorInfoContext()
        {
            ...
            using (Stream stream = new MemoryStream())
            {
                ...
                AuthenticationException serial = new AuthenticationException(message, cause);
